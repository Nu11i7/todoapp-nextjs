                        ...
                        Object.values(providers).map((provider) => (
                            <div key={provider.id} className="text-center">
                                <button
                                    ...
                                    className={`${provider.id === "github" ? "bg-gray-900 text-white hover:bg-gray-700" : "bg-white text-gray-900 border border-gray-900 hover:bg-gray-100"
                                        } font-bold py-2 px-4 h-10 rounded flex items-center justify-center w-full`}
                                >
                                    {provider.id === "github" ? (
                                        <>
                                            <svg
